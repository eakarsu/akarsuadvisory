    ...
    <div className="admin-page">
      ...
      <div className="admin-table-wrap">
        <table className="admin-table">
          <thead><tr><th>Name</th><th>Email</th><th>Company</th><th>Service</th><th>Date</th><th>Status</th><th>Actions</th></tr></thead>
          <tbody>
            {filtered.map(i => (
            ...
            {filtered.length === 0 && <tr><td colSpan={7} style={{ textAlign: 'center', padding: 40, color: '#94a3b8' }}>No consultations found.</td></tr>}
          </tbody>
        </table>
      </div>
              ...
              {aiReply ? (
                <div style={{ padding: 16, background: '#f7f7f7', borderRadius: 8, border: '1px solid #99f6e4' }}>
                  ...
                  <div style={{ marginTop: 12, display: 'flex', gap: 8 }}>
                    ...
                    <a href={`mailto:${selected.email}?subject=Re: Consultation Request - Akarsu Advisory&body=${encodeURIComponent(aiReply)}`} className="btn btn-primary" style={{ padding: '6px 14px', fontSize: 12, textDecoration: 'none' }}>Send via Email</a>
                  </div>
                </div>
              ) : (
